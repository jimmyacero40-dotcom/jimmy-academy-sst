...
export default function PorteriaPage() {
  ...
  async function registerEntry(worker: Worker) {
    ...
    if (res.ok) {
      ...
      showToast(err.error || 'Error al registrar ingreso', 'err')
    }
    setRegistering(null)
  }
  ...
  return (
    <div className="p-6 w-full space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          { label: 'Pueden entrar', value: canEnterCount, color: '#10B981', bg: 'rgba(16,185,129,0.1)' },
          { label: 'Ya dentro',     value: insideCount,   color: 'var(--primary)', bg: 'var(--primary-dim)' },
          { label: 'Bloqueados',    value: blockedCount,  color: '#EF4444', bg: 'rgba(239,68,68,0.1)' },
