...
const allNavItems = [
  ...
  { href: '/dashboard/my-profile',  icon: Briefcase,      label: 'Mi Perfil',        roles: ['worker'] },
  { href: '/dashboard/worker-profiles', icon: UserCheck,  label: 'Perfiles',         roles: ['superadmin', 'admin'] },
